...
import type { Draft, Options, Patch } from 'mutative';
...
export type MutativeReducer<R, I> = (
  draftState: DraftedObject<R>,
  action: I
) => void | DraftedObject<R>;
...
>(
  ...
  initialState: R,
  initializer?: (arg: DraftedObject<R>) => R,
  options?: Options<O, F>
